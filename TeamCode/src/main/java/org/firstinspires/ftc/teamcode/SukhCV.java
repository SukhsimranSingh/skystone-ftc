...
public class SukhCV extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("Frame Count", webcamRed.getFrameCount());
            telemetry.addData("FPS", String.format(Locale.US, "%.2f", webcamRed.getFps()));
            telemetry.addData("Total frame time ms", webcamRed.getTotalFrameTimeMs());
            telemetry.addData("Pipeline time ms", webcamRed.getPipelineTimeMs());
            telemetry.addData("Overhead time ms", webcamRed.getOverheadTimeMs());
            telemetry.addData("Theoretical max FPS", webcamRed.getCurrentPipelineMaxFps());
            telemetry.update();
             ...
             */
                ...
                webcamRed.pauseViewport();
            }
            else if(gamepad1.y) {
                webcamRed.resumeViewport();
            }
        }
    }
}