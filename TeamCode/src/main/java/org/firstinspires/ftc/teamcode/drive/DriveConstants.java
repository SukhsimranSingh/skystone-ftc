...
import org.firstinspires.ftc.teamcode.SukhMotor;
...
public class DriveConstants {
    ...
    private static final MotorConfigurationType MOTOR_CONFIG =
            MotorConfigurationType.getMotorType(SukhMotor.class);
    ...
    public static double TRACK_WIDTH = 18.90;
     ...
     * empirically tuned.
     */
    public static double kV = (1.0 / rpmToVelocity(getMaxRpm())/ 1.5);
    ...
    public static double encoderTicksToInches(double ticks) {
        return WHEEL_RADIUS * 2 * Math.PI * ticks  / (MOTOR_CONFIG.getTicksPerRev());
    }
